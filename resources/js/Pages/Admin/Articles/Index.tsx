...
export default function Index({
    ...
    const confirmDelete = () => {
        ...
        setProcessing(true);
        router.delete(`/admin/articles/${deleting.slug}`, {
            preserveScroll: true,
            onFinish: () => {
                setProcessing(false);
                setDeleting(null);
    ...
    return (
        <AdminLayout header={<h2 className="text-xl font-semibold text-slate-800">Articles</h2>}>
            ...
            <AdminIndexFilters url="/admin/articles" filters={filters} fields={filterFields} />
                    ...
                    <table className="w-full min-w-[860px] table-fixed divide-y divide-slate-200 text-sm">
                        <thead className="bg-slate-50">
                            <tr>
                                ...
                                <th className="w-40 px-4 py-3 text-left font-medium text-slate-600">Published</th>
                                ...
                                articles.data.map((article) => (
                                    <tr key={article.id} className="hover:bg-slate-50/80">
                                        ...
                                        <td className="px-4 py-3 text-slate-600">
                                            <span className="line-clamp-2">{article.subtitle || '—'}</span>
                                        </td>
                                        <td className="px-4 py-3 text-slate-600">
